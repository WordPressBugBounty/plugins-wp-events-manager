...
<tr valign="top" <?php echo $field['class'] ? 'class="' . esc_attr( $field['class'] ) . '"' : ''; ?>>
	...
	<td class="event-form-field event-form-field-<?php echo esc_attr( $field['type'] ); ?>">
		<input type="hidden" name="<?php echo isset( $field['field_name'] ) ? esc_attr( $field['field_name'] ) : ''; ?>" value="0" />
		<input type="checkbox" id="<?php echo isset( $field['id'] ) ? esc_attr( $field['id'] ) : ''; ?>" name="<?php echo isset( $field['field_name'] ) ? esc_attr( $field['field_name'] ) : ''; ?>" value="1"
